...
export default class StoryCard extends Component {
  constructor(props) {
    ...
    this.state = {
      fontsLoaded: false,
      light_theme: true,
      complaint_id: this.props.complaint.key,
      complaint_data: this.props.complaint.value,
      is_liked: false,
      //likes: this.props.complaint.value.likes
    };
  }
  ...
  render() {
    let complaint = this.state.complaint_data;
    if (!this.state.fontsLoaded) {
      ...
      return (
        ...
        >
          ...
          >
            <Image
              source={images[complaint.preview_image]}
